...
import com.example.hilibrary.restful.annotation.*
import java.lang.reflect.*



class MethodParser constructor(var baseurl:String, var method: Method) {
    ...
    private fun parseMethodReturnType(method: Method) {
        ...
        val genericReturnType = method.genericReturnType //返回类型（带泛型）
        if (genericReturnType is ParameterizedType) { //判断是泛型类型
            val actualTypeArguments = genericReturnType.actualTypeArguments //获取泛型
